            ...
            <nav className={`main-menu ${sticky && "stricky-header stricked-menu stricky-fixed"}`}>
                <div className="container-fluid">
                    <div className="main-menu__logo">
                        ...
                        <Link to="/">
                            <img src={logo} width="130" height="81" alt="Global Cash Finance"/>
                        </Link>
                    </div>
                    ...
                    <div className="main-menu__right">
                        ...
                        <a href="https://app.globalcash.ng" className="thm-btn main-menu__btn">Request Loan</a>
        ...
        <div className={`mobile-nav__wrapper ${mobile ? "expanded" : ""}`}>
                ...
                <div className="mobile-nav__content">
                    ...
                    <div className="logo-box">
                        <Link to="/" aria-label="logo image"><img src={logo} width="155" alt="" /></Link>
                    </div>
